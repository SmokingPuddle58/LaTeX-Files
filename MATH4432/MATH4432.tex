...
Thus we are actually more interested in the following: $$\min_{\hat{f}}\ev_{\mathcal{D}}[f(x_0)-\hat{f}(x_0,\mathcal{D})|X=x_0]^2$$

\begin{thmbox}
    \begin{theorem}
        \begin{eqnarray*}
            \ev_{\mathcal{D}}[f(x_0)-\hat{f}(x_0,\mathcal{D})|X=x_0]^2&=&\underbrace{[f(x_0)-\ev_{\mathcal{D}}(\hat{f}(x_0,\mathcal{D}))|X=x_0]^2}_{\text{Bias}^2}\\
            &+&\underbrace{\ev_{\mathcal{D}}[[\ev_{\mathcal{D}}(\hat{f}(x_0,\mathcal{D}))-\hat{f}(x_0,\mathcal{D})|X=x_0]^2]}_{\text{Variance}}
        \end{eqnarray*}
    \end{theorem}
    \begin{prfbox}
        \begin{proof}
