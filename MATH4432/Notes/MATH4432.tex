...
\begin{thmbox}
    \begin{theorem}
        ...
        \begin{notebox}
            \begin{note}
                The reason why the denominator is $n-2$, is because we are estimating 2 parameters. This is related to degree of freedom.
                ...
                \begin{expbox}
                    \begin{example}
                        ...
                        Suppose we now know the value of $z_1,z_2$ and $\mu$. Then we will also know the value of $z_3$. The number of sample is no longer 3, since
